...
export default async function HomePage() {
  ...
  return (
    <div>
      <section
        className="relative flex min-h-[560px] items-end bg-cover bg-center text-white md:min-h-[620px]"
        style={{
          backgroundImage:
      ...
      >
        <div className="mx-auto w-full max-w-6xl px-5 pb-16 pt-20 md:px-6 md:pb-24">
      ...
      <section className="mx-auto max-w-6xl px-5 py-8 md:px-6 md:py-12">
        ...
        <div className="mt-8 flex items-end justify-between gap-4">
          <div>
            ...
            <h2 className="mt-1 text-2xl font-bold text-ink">Komponenty, které právě hledají nové kolo</h2>
          </div>
      ...
      <section className="border-y border-line bg-white">
        <div className="mx-auto grid max-w-6xl gap-5 px-5 py-8 md:grid-cols-3 md:px-6 md:py-10">
          {[
