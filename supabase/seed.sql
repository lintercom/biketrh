...
values
  (
    ...
    'authenticated',
    'authenticated',
    'martin@bikebazar.test',
    crypt('bikebazar123', gen_salt('bf')),
    now(),
    now(),
    now(),
...
values
  (
    ...
    '11111111-1111-4111-8111-111111111111',
    'martin@bikebazar.test',
    jsonb_build_object('sub', '11111111-1111-4111-8111-111111111111', 'email', 'martin@bikebazar.test'),
    'email',
    now(),
    now(),
    now()
  ...
  (
    ...
    '22222222-2222-4222-8222-222222222222',
    'tereza@bikebazar.test',
    jsonb_build_object('sub', '22222222-2222-4222-8222-222222222222', 'email', 'tereza@bikebazar.test'),
    'email',
    now(),
    now(),
    now()
